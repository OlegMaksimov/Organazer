...
export class TaskService {
    ...
    private convertItemFromServer(task: Task): Task {
        ...
        copy.dateStart = this.dateUtils
            .convertDateTimeFromServer(task.dateStart);
        copy.dateEnd = this.dateUtils
            .convertDateTimeFromServer(task.dateEnd);
        return copy;
    }
    ...
    private convert(task: Task): Task {
        ...
        copy.dateStart = this.dateUtils.toDate(task.dateStart);

        copy.dateEnd = this.dateUtils.toDate(task.dateEnd);
        return copy;
    }
}
