...
public class CategoryResourceIntTest {
    ...
    private static final Long DEFAULT_CONTENTMENT = 1L;
    private static final Long UPDATED_CONTENTMENT = 2L;
    ...
    public static Category createEntity(EntityManager em) {
        Category category = new Category()
            ...
            .contentment(DEFAULT_CONTENTMENT);
        return category;
    }
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getDiscription()).isEqualTo(DEFAULT_DISCRIPTION);
        assertThat(testCategory.getContentment()).isEqualTo(DEFAULT_CONTENTMENT);
    }
    ...
    public void getAllCategories() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].contentment").value(hasItem(DEFAULT_CONTENTMENT.intValue())));
    }
    ...
    public void getCategory() throws Exception {
        ...
        restCategoryMockMvc.perform(get("/api/categories/{id}", category.getId()))
            ...
            .andExpect(jsonPath("$.contentment").value(DEFAULT_CONTENTMENT.intValue()));
    }
    ...
    public void updateCategory() throws Exception {
        ...
        updatedCategory
            ...
            .contentment(UPDATED_CONTENTMENT);
        ...
        assertThat(testCategory.getDiscription()).isEqualTo(UPDATED_DISCRIPTION);
        assertThat(testCategory.getContentment()).isEqualTo(UPDATED_CONTENTMENT);
    }
